    ...
    <div className="wraper">
      <div className="app-wraper">
        ...
        <div className="app-wraper__block">
          ...
          <div className="app-wraper__block__text3">
      ...
      <Slider {...settings}>
        <SliderBlock
          src={slide1}
          text1="Бесплатная парковка"
          text2="Оставляйте машину на платных городских парковках и разрешенных местах, не нарушая ПДД, а также в аэропортах"
          buttonColor=""
        />
        <SliderBlock
          src={slide2}
          text1="Страховка"
          text2="Полная страховка страховка автомобиля"
          buttonColor="color__slide2"
        />
        <SliderBlock
          src={slide3}
          text1="Бензин"
          text2="Полный бак на любой заправке города за наш счёт"
          buttonColor="color__slide3"
        />
        <SliderBlock
          src={slide4}
          text1="Обслуживание"
          text2="Автомобиль проходит еженедельное ТО"
